  ...
  try {
    ...
    let browserConfig = isProd
      ? {
          ...
          executablePath: "/usr/bin/chromium-browser", // Fixed path for Docker
          headless: true,
          args: [
            "--no-sandbox",
        ...
        <div class="document">
          ...
          <div class="order-meta">
            <div class="meta-item">
              ...
              <span class="meta-value">#${order.orderNumber || order._id.toString().slice(-6)}</span>
            </div>
            <div class="meta-item">
            ...
            <div class="meta-item">
              ...
              <span class="meta-value">${order.customer.institution}</span>
            </div>
            <div class="meta-item">
              <span class="meta-label">Mobile Number</span>
              <span class="meta-value">${order.customer.mobileNumber}</span>
            </div>
            <div class="meta-item">
              <span class="meta-label">Email</span>
              <span class="meta-value">${order.customer.email}</span>
            </div>
          </div>
